...
//I comadandi prima di Stampa hanno bisogno di altri comadandi
...
comandi_e leggiComando(void) {
    comandi_e c;
    char cmd[MAX];
    char *tabella[r_err] = {"date", "partenza", "capolinea", "ritardo", "ritardo_tot", "stampa", "ordine_data", "ordine_tratta", "ordine_partenza", "ordine_arrivo", "ricerca_partenza", "fine"};
